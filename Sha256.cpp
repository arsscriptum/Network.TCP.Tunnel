...
void sha256_update( sha256_context *ctx, BYTE *input, ULONG length );
void sha256_final( sha256_context *ctx, BYTE digest[SHA_SIZE_256] );
...
void sha256Digest(const unsigned char * data, int length, unsigned char digest[SHA_SIZE_256])
{
	...
	sha256_update( &ctx, const_cast<unsigned char *>(data), length );
